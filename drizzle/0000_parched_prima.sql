...
CREATE TABLE "certificates" (
	...
	"created_at" timestamp with time zone DEFAULT now() NOT NULL,
	"updated_at" timestamp with time zone DEFAULT now() NOT NULL,
	CONSTRAINT "cert_min_progress_range" CHECK ("certificates"."min_progress_pct" >= 0 AND "certificates"."min_progress_pct" <= 100),
	CONSTRAINT "cert_min_quiz_score_range" CHECK ("certificates"."min_quiz_score" >= 0 AND "certificates"."min_quiz_score" <= 100)
);
--> statement-breakpoint
...
CREATE TABLE "course_progress" (
	...
	"created_at" timestamp with time zone DEFAULT now() NOT NULL,
	"updated_at" timestamp with time zone DEFAULT now() NOT NULL,
	CONSTRAINT "cp_progress_pct_range" CHECK ("course_progress"."progress_pct" >= 0 AND "course_progress"."progress_pct" <= 100)
);
--> statement-breakpoint
...
CREATE TABLE "platform_settings" (
	...
	"show_hero_video" boolean DEFAULT true NOT NULL,
	"support_email" text,
...
CREATE TABLE "students" (
	...
	"privacy_settings" jsonb DEFAULT '{"public_profile":true}'::jsonb NOT NULL,
	"created_at" timestamp with time zone DEFAULT now() NOT NULL,
	"updated_at" timestamp with time zone DEFAULT now() NOT NULL,
	"deleted_at" timestamp with time zone
);
...
ALTER TABLE "course_class_mapping" ADD CONSTRAINT "course_class_mapping_course_id_courses_id_fk" FOREIGN KEY ("course_id") REFERENCES "public"."courses"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "course_class_mapping" ADD CONSTRAINT "course_class_mapping_class_id_classes_id_fk" FOREIGN KEY ("class_id") REFERENCES "public"."classes"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "course_metrics_daily" ADD CONSTRAINT "course_metrics_daily_course_id_courses_id_fk" FOREIGN KEY ("course_id") REFERENCES "public"."courses"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "course_progress" ADD CONSTRAINT "course_progress_user_id_students_id_fk" FOREIGN KEY ("user_id") REFERENCES "public"."students"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "courses" ADD CONSTRAINT "courses_created_by_super_admins_id_fk" FOREIGN KEY ("created_by") REFERENCES "public"."super_admins"("id") ON DELETE restrict ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "enrollments" ADD CONSTRAINT "enrollments_user_id_students_id_fk" FOREIGN KEY ("user_id") REFERENCES "public"."students"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "invoices" ADD CONSTRAINT "invoices_school_id_schools_id_fk" FOREIGN KEY ("school_id") REFERENCES "public"."schools"("id") ON DELETE restrict ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "invoices" ADD CONSTRAINT "invoices_subscription_id_school_subscriptions_id_fk" FOREIGN KEY ("subscription_id") REFERENCES "public"."school_subscriptions"("id") ON DELETE restrict ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "invoices" ADD CONSTRAINT "invoices_transaction_id_payment_transactions_id_fk" FOREIGN KEY ("transaction_id") REFERENCES "public"."payment_transactions"("id") ON DELETE set null ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "lesson_progress" ADD CONSTRAINT "lesson_progress_user_id_students_id_fk" FOREIGN KEY ("user_id") REFERENCES "public"."students"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "lessons" ADD CONSTRAINT "lessons_asset_id_media_assets_id_fk" FOREIGN KEY ("asset_id") REFERENCES "public"."media_assets"("id") ON DELETE set null ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "pin_reset_requests" ADD CONSTRAINT "pin_reset_requests_student_id_students_id_fk" FOREIGN KEY ("student_id") REFERENCES "public"."students"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "pin_reset_requests" ADD CONSTRAINT "pin_reset_requests_school_id_schools_id_fk" FOREIGN KEY ("school_id") REFERENCES "public"."schools"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "pin_reset_requests" ADD CONSTRAINT "pin_reset_requests_resolved_by_school_admins_id_fk" FOREIGN KEY ("resolved_by") REFERENCES "public"."school_admins"("id") ON DELETE set null ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "school_class_mapping" ADD CONSTRAINT "school_class_mapping_school_id_schools_id_fk" FOREIGN KEY ("school_id") REFERENCES "public"."schools"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "school_class_mapping" ADD CONSTRAINT "school_class_mapping_class_id_classes_id_fk" FOREIGN KEY ("class_id") REFERENCES "public"."classes"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "school_metrics_daily" ADD CONSTRAINT "school_metrics_daily_school_id_schools_id_fk" FOREIGN KEY ("school_id") REFERENCES "public"."schools"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "school_subscriptions" ADD CONSTRAINT "school_subscriptions_school_id_schools_id_fk" FOREIGN KEY ("school_id") REFERENCES "public"."schools"("id") ON DELETE restrict ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "school_subscriptions" ADD CONSTRAINT "school_subscriptions_plan_id_payment_plans_id_fk" FOREIGN KEY ("plan_id") REFERENCES "public"."payment_plans"("id") ON DELETE restrict ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "school_subscriptions" ADD CONSTRAINT "school_subscriptions_promo_code_id_promo_codes_id_fk" FOREIGN KEY ("promo_code_id") REFERENCES "public"."promo_codes"("id") ON DELETE set null ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "student_academic_records" ADD CONSTRAINT "student_academic_records_user_id_students_id_fk" FOREIGN KEY ("user_id") REFERENCES "public"."students"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "student_academic_records" ADD CONSTRAINT "student_academic_records_school_id_schools_id_fk" FOREIGN KEY ("school_id") REFERENCES "public"."schools"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "student_academic_records" ADD CONSTRAINT "student_academic_records_session_id_academic_sessions_id_fk" FOREIGN KEY ("session_id") REFERENCES "public"."academic_sessions"("id") ON DELETE restrict ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "student_academic_records" ADD CONSTRAINT "student_academic_records_class_id_classes_id_fk" FOREIGN KEY ("class_id") REFERENCES "public"."classes"("id") ON DELETE restrict ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "student_academic_records" ADD CONSTRAINT "student_academic_records_promoted_by_school_admins_id_fk" FOREIGN KEY ("promoted_by") REFERENCES "public"."school_admins"("id") ON DELETE set null ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "user_achievements" ADD CONSTRAINT "user_achievements_user_id_students_id_fk" FOREIGN KEY ("user_id") REFERENCES "public"."students"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "user_achievements" ADD CONSTRAINT "user_achievements_achievement_id_achievements_id_fk" FOREIGN KEY ("achievement_id") REFERENCES "public"."achievements"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "user_certificates" ADD CONSTRAINT "user_certificates_user_id_students_id_fk" FOREIGN KEY ("user_id") REFERENCES "public"."students"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "user_certificates" ADD CONSTRAINT "user_certificates_certificate_id_certificates_id_fk" FOREIGN KEY ("certificate_id") REFERENCES "public"."certificates"("id") ON DELETE restrict ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "user_certificates" ADD CONSTRAINT "user_certificates_enrollment_id_enrollments_id_fk" FOREIGN KEY ("enrollment_id") REFERENCES "public"."enrollments"("id") ON DELETE restrict ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "user_daily_challenges" ADD CONSTRAINT "user_daily_challenges_user_id_students_id_fk" FOREIGN KEY ("user_id") REFERENCES "public"."students"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "xp_events" ADD CONSTRAINT "xp_events_user_id_students_id_fk" FOREIGN KEY ("user_id") REFERENCES "public"."students"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "xp_events" ADD CONSTRAINT "xp_events_school_id_schools_id_fk" FOREIGN KEY ("school_id") REFERENCES "public"."schools"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
...
CREATE INDEX "idx_audit_school_created" ON "audit_logs" USING btree ("school_id","created_at");--> statement-breakpoint
CREATE UNIQUE INDEX "uq_classes_name" ON "classes" USING btree ("name") WHERE deleted_at IS NULL;--> statement-breakpoint
CREATE UNIQUE INDEX "uq_classes_level" ON "classes" USING btree ("level") WHERE deleted_at IS NULL;--> statement-breakpoint
...
CREATE UNIQUE INDEX "uq_course_metric_date" ON "course_metrics_daily" USING btree ("course_id","metric_date");--> statement-breakpoint
CREATE UNIQUE INDEX "uq_user_course_enrollment" ON "course_progress" USING btree ("user_id","course_id","enrollment_id");--> statement-breakpoint
...
CREATE INDEX "idx_course_topics" ON "courses" USING gin ("topics");--> statement-breakpoint
CREATE INDEX "idx_daily_challenge_date" ON "daily_challenges" USING btree ("challenge_date");--> statement-breakpoint
CREATE UNIQUE INDEX "uq_daily_challenge_item" ON "daily_challenges" USING btree ("challenge_date","title");--> statement-breakpoint
...
CREATE INDEX "idx_enrollments_school" ON "enrollments" USING btree ("school_id");--> statement-breakpoint
CREATE INDEX "idx_enroll_user_active" ON "enrollments" USING btree ("user_id","is_active");--> statement-breakpoint
CREATE UNIQUE INDEX "uq_user_lesson" ON "lesson_progress" USING btree ("user_id","lesson_id","enrollment_id");--> statement-breakpoint
CREATE INDEX "idx_lp_user" ON "lesson_progress" USING btree ("user_id");--> statement-breakpoint
...
CREATE INDEX "idx_login_email" ON "login_attempts" USING btree ("email");--> statement-breakpoint
CREATE INDEX "idx_login_created" ON "login_attempts" USING btree ("created_at");--> statement-breakpoint
CREATE INDEX "idx_media_asset_type" ON "media_assets" USING btree ("asset_type");--> statement-breakpoint
CREATE INDEX "idx_media_uploaded_by" ON "media_assets" USING btree ("uploaded_by");--> statement-breakpoint
CREATE INDEX "idx_media_folder" ON "media_assets" USING btree ("folder");--> statement-breakpoint
CREATE INDEX "idx_media_storage_type" ON "media_assets" USING btree ("storage_type");--> statement-breakpoint
CREATE INDEX "idx_media_created" ON "media_assets" USING btree ("created_at");--> statement-breakpoint
...
CREATE UNIQUE INDEX "uq_payment_plans_name" ON "payment_plans" USING btree ("name") WHERE deleted_at IS NULL;--> statement-breakpoint
...
CREATE INDEX "idx_pin_reset_student" ON "pin_reset_requests" USING btree ("student_id");--> statement-breakpoint
CREATE INDEX "idx_pin_reset_school" ON "pin_reset_requests" USING btree ("school_id");--> statement-breakpoint
CREATE INDEX "idx_pin_reset_status" ON "pin_reset_requests" USING btree ("status");--> statement-breakpoint
CREATE UNIQUE INDEX "uq_promo_codes_code" ON "promo_codes" USING btree ("code") WHERE deleted_at IS NULL;--> statement-breakpoint
...
CREATE INDEX "idx_qattempts_user_quiz" ON "quiz_attempts" USING btree ("user_id","quiz_id");--> statement-breakpoint
...
CREATE UNIQUE INDEX "uq_school_metric_date" ON "school_metrics_daily" USING btree ("school_id","metric_date");--> statement-breakpoint
CREATE INDEX "idx_subscriptions_school" ON "school_subscriptions" USING btree ("school_id");--> statement-breakpoint
CREATE INDEX "idx_subscriptions_status" ON "school_subscriptions" USING btree ("status");--> statement-breakpoint
...
CREATE UNIQUE INDEX "uq_student_session" ON "student_academic_records" USING btree ("user_id","session_id");--> statement-breakpoint
CREATE INDEX "idx_sar_school_session" ON "student_academic_records" USING btree ("school_id","session_id");--> statement-breakpoint
CREATE UNIQUE INDEX "uq_students_email" ON "students" USING btree ("email") WHERE deleted_at IS NULL;--> statement-breakpoint
CREATE UNIQUE INDEX "uq_students_phone" ON "students" USING btree ("phone") WHERE deleted_at IS NULL;--> statement-breakpoint
CREATE INDEX "idx_students_school" ON "students" USING btree ("school_id");--> statement-breakpoint
CREATE INDEX "idx_students_xp" ON "students" USING btree ("cumulative_xp");--> statement-breakpoint
CREATE UNIQUE INDEX "uq_user_achievement" ON "user_achievements" USING btree ("user_id","achievement_id");--> statement-breakpoint
CREATE UNIQUE INDEX "uq_user_cert_enrollment" ON "user_certificates" USING btree ("user_id","certificate_id","enrollment_id");--> statement-breakpoint
CREATE UNIQUE INDEX "uq_user_daily_challenge" ON "user_daily_challenges" USING btree ("user_id","challenge_id");--> statement-breakpoint
...
CREATE INDEX "idx_xp_user" ON "xp_events" USING btree ("user_id");--> statement-breakpoint
CREATE INDEX "idx_xp_school" ON "xp_events" USING btree ("school_id");--> statement-breakpoint
CREATE INDEX "idx_xp_created" ON "xp_events" USING btree ("created_at");--> statement-breakpoint
CREATE INDEX "idx_xp_user_created" ON "xp_events" USING btree ("user_id","created_at");--> statement-breakpoint
CREATE INDEX "idx_xp_user_ref_source" ON "xp_events" USING btree ("user_id","reference_id","source");