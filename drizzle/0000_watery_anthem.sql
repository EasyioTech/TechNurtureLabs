...
ALTER TABLE "student_academic_records" ADD CONSTRAINT "student_academic_records_user_id_users_id_fk" FOREIGN KEY ("user_id") REFERENCES "public"."users"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "student_academic_records" ADD CONSTRAINT "student_academic_records_promoted_by_users_id_fk" FOREIGN KEY ("promoted_by") REFERENCES "public"."users"("id") ON DELETE set null ON UPDATE no action;--> statement-breakpoint
...
CREATE UNIQUE INDEX "uq_course_class" ON "course_class_mapping" USING btree ("course_id","class_id");--> statement-breakpoint
...
CREATE UNIQUE INDEX "uq_daily_challenge_date" ON "daily_challenges" USING btree ("challenge_date");--> statement-breakpoint
CREATE UNIQUE INDEX "uq_enrollment" ON "enrollments" USING btree ("user_id","course_id","session_id");--> statement-breakpoint
...
CREATE UNIQUE INDEX "uq_lesson_sequence_per_course" ON "lessons" USING btree ("course_id","sequence_order");--> statement-breakpoint
...
CREATE UNIQUE INDEX "uq_quiz_attempt" ON "quiz_attempts" USING btree ("user_id","quiz_id","enrollment_id","attempt_number");--> statement-breakpoint
CREATE UNIQUE INDEX "uq_quiz_question_sequence" ON "quiz_questions" USING btree ("quiz_id","sequence_order");--> statement-breakpoint
CREATE UNIQUE INDEX "uq_school_class" ON "school_class_mapping" USING btree ("school_id","class_id");--> statement-breakpoint
...
CREATE UNIQUE INDEX "uq_users_email_active" ON "users" USING btree ("email");--> statement-breakpoint
CREATE INDEX "idx_users_school" ON "users" USING btree ("school_id");--> statement-breakpoint
CREATE INDEX "idx_users_role" ON "users" USING btree ("role");--> statement-breakpoint
CREATE INDEX "idx_users_cumulative_xp" ON "users" USING btree ("cumulative_xp");--> statement-breakpoint
