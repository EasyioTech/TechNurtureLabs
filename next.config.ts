...
const nextConfig: NextConfig = {
  ...
  async headers() {
    ...
    const csp = [
      ...
      "frame-src 'self' https://youtube.com https://*.youtube.com https://youtube-nocookie.com https://*.youtube-nocookie.com https://player.vimeo.com https://*.vimeo.com https://*.videodelivery.net https://videodelivery.net https://iframe.videodelivery.net https://checkout.razorpay.com https://api.razorpay.com https://*.razorpay.com https://docs.google.com",
    ...
    return [
      ...
      // Cache-busting for Server Actions and dynamic content — prevents stale Server Action errors
      {
        source: '/api/rsc/:path*',
