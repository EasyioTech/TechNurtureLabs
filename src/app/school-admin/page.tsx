...
import { getSchoolAdminDashboardData, updateSchoolBranding, promoteStudentsAction } from '@/modules/school-admin/actions';
...
import { StatCard } from '@/modules/school-admin/components/stats-card';
import { TopPerformerRow } from '@/modules/school-admin/components/top-performer';
import { ActivityRow } from '@/modules/school-admin/components/activity-row';
import { StudentTableRow } from '@/modules/school-admin/components/student-table-row';
import { CourseCard } from '@/modules/school-admin/components/course-card';
import { Student, Course, ClassData, StatsData, RecentActivity, ClassProgressData } from '@/modules/school-admin/types';
