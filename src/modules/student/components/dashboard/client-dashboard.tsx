...
export function ClientDashboard({ initialData }: ClientDashboardProps) {
  ...
  }, [searchQuery, courses, challenges]);
  ...
  return (
    <div className="min-h-screen bg-slate-50/10 pb-20 selection:bg-indigo-100 selection:text-indigo-900">
      ...
      <main className="max-w-[1440px] mx-auto px-4 sm:px-6 lg:px-8 py-6 lg:py-10 animate-in fade-in slide-in-from-bottom-4 duration-700">
        ...
        <div className="grid grid-cols-1 xl:grid-cols-12 gap-6 lg:gap-8">
          <div className="xl:col-span-8 space-y-10 lg:space-y-12">
            ...
            {lastCourse && (
              <section className="group">
                <div className="relative overflow-hidden rounded-[2rem] sm:rounded-[2.5rem] bg-slate-950 p-6 sm:p-8 lg:p-10 text-white shadow-2xl shadow-indigo-950/20 border border-white/5 transition-all duration-1000">
                  <div className="absolute top-0 right-0 w-[400px] h-[400px] bg-indigo-500/10 rounded-full -mr-32 -mt-32 blur-[100px] pointer-events-none group-hover:bg-indigo-500/20 transition-all duration-[2000ms]" />
                  ...
                  <div className="relative z-10 flex flex-col lg:flex-row lg:items-center justify-between gap-8 sm:gap-10">
                    <div className="flex-1 min-w-0">
                      ...
                      <Link href={`/student/course/${lastCourse.id}`} className="block sm:inline-block">
                        <Button className="w-full sm:w-auto h-12 sm:h-13 px-8 sm:px-10 rounded-xl bg-white text-slate-950 font-black uppercase tracking-[0.2em] text-[9px] hover:bg-white/90 transition-all active:scale-95 shadow-2xl shadow-indigo-900/20 group/btn">
                          {lastCourse.completedLessons === lastCourse.totalLessons 
                            ? 'Revise Module' 
                            : (lastCourse.completedLessons > 0 ? 'Resume Course' : 'Start Journey')}
                          <ArrowRight size={16} className="ml-2.5 group-hover/btn:translate-x-1.5 transition-transform duration-500" />
                        </Button>
                      </Link>
                    </div>
                    ...
                    <div className="hidden lg:flex relative w-36 h-36 lg:w-44 lg:h-44 flex-shrink-0">
                      <svg className="w-full h-full -rotate-90" viewBox="0 0 160 160">
                        ...
                        <motion.circle
                          ...
                          transition={{ duration: 2, ease: "easeOut" }}
                          className="text-indigo-500 shadow-[0_0_20px_rgba(99,102,241,0.3)]"
                          strokeLinecap="round"
                        />
                      </svg>
                      <div className="absolute inset-0 flex flex-col items-center justify-center">
                        <span className="text-3xl lg:text-4xl font-black tracking-tighter">{Math.round((lastCourse.completedLessons / (lastCourse.totalLessons || 1)) * 100)}%</span>
          ...
          <div className="xl:col-span-4 space-y-8">
            ...
            <div className="relative group">
              <div className="bg-white rounded-[2rem] p-2.5 shadow-xl shadow-slate-200/40 border border-slate-100 flex items-center gap-3 transition-all focus-within:ring-2 focus-within:ring-indigo-500/20 focus-within:border-indigo-100">
            ...
            <div className="bg-slate-950 rounded-[2rem] p-6 lg:p-7 text-white relative overflow-hidden shadow-2xl shadow-indigo-950/40 border border-white/5 group">
              <div className="absolute top-0 right-0 w-48 h-48 bg-indigo-500/10 rounded-full blur-[80px] pointer-events-none group-hover:bg-indigo-600/20 transition-all duration-1000" />
              <div className="relative z-10">
                <div className="flex items-center justify-between mb-6">
                  ...
                  <div className="w-12 h-12 rounded-full bg-white/5 backdrop-blur-xl flex items-center justify-center border border-white/10 shadow-2xl transition-transform group-hover:rotate-6">
            ...
            <div className="grid grid-cols-2 gap-4">
              <Link href="/student/analytics" className="group">
                <div className="h-32 rounded-[2rem] bg-indigo-50/50 p-6 flex flex-col justify-between border border-indigo-100/50 hover:bg-indigo-100/80 hover:scale-[1.02] active:scale-95 transition-all relative overflow-hidden">
              ...
              <Link href="/student/leaderboard" className="group">
                <div className="h-32 rounded-[2rem] bg-amber-50/50 p-6 flex flex-col justify-between border border-amber-100/50 hover:bg-amber-100/80 hover:scale-[1.02] active:scale-95 transition-all relative overflow-hidden">
                  <div className="absolute top-0 right-0 w-24 h-24 bg-white/40 rounded-full -mr-8 -mt-8 blur-2xl" />
            ...
            {/* Daily Goals */}
            <section className="bg-white rounded-3xl p-5 border border-slate-100 shadow-md group">
