...
export const NeumorphicButton = React.forwardRef<HTMLButtonElement, NeumorphicButtonProps>(
    ({ children, className, variant = 'flat', size = 'md', ...props }, ref) => {
        ...
        const variants = {
            flat: "bg-slate-50 text-slate-700 shadow-[6px_6px_12px_#cbd5e1,-6px_-6px_12px_#ffffff] hover:shadow-[4px_4px_8px_#cbd5e1,-4px_-4px_8px_#ffffff] hover:-translate-y-[1px] active:shadow-[inset_4px_4px_8px_#cbd5e1,inset_-4px_-4px_8px_#ffffff]",
            pressed: "bg-slate-50 text-slate-700 shadow-[inset_6px_6px_12px_#cbd5e1,inset_-6px_-6px_12px_#ffffff]",
            primary: "bg-indigo-500 text-white shadow-[6px_6px_12px_#cbd5e1,-6px_-6px_12px_#ffffff] hover:shadow-[4px_4px_8px_#cbd5e1,-4px_-4px_8px_#ffffff] hover:-translate-y-[1px] active:shadow-[inset_4px_4px_8px_#4f46e5,inset_-4px_-4px_8px_#818cf8] active:translate-y-[1px]"
        };
